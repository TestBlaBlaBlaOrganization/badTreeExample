...
public class RunningTrack extends Test {

    public RunningTrack(int ENERGY_COST) { super(ENERGY_COST); }
    ...
    public boolean test(Сompetitor competitor) {
        ...
        if (competitor.run(ENERGY_COST)) {
            System.out.println("успешно преодалев расстояние в " + ENERGY_COST + " единиц.");
            return true;
        }
        System.out.println("не преодалев расстояние в " + ENERGY_COST + " единиц.");
        return false;
    }
